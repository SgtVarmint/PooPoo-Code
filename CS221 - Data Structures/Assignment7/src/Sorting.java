 ...
 * - Radix Sort
 *
 * for arrays of sizes 10,000 , 100,000 , and 1,000,000, and 1,000,000,000
 */
public class Sorting {
	...
	public static void main(String[] args) {
		...
		for(int i=power;i<=1000000;i*=10) {
			...
			if(isSorted(mergeArray) && isSorted(quickArray) && isSorted(radixArray) && isSorted(heapArray))
				System.out.println("4/4 sorts work");

		}
	}
	/**
	 * Takes in all above arrays and calls their respective sort methods
	 * @param length
	 * @param quickArray
	 * @param mergeArray
	 * @param heapArray
	...
	/**
	 * Helper method that calls the actual radixSort method
	 * @param array
	 */
